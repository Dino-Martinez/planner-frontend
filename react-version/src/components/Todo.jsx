...
function Todo(props) {
    return (
        <li className="todo">
            <svg id={`complete-${props._id}`} onClick={() => props.toggle(props._id, props.completed)} className={`check-mark check-${props.completed}`} xmlns="http://www.w3.org/2000/svg" width="11" height="9"><path fill="none" stroke="#000" strokeWidth="2" d="M1 4.304L3.696 7l6-6"/></svg>
